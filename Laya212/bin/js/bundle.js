(function () {
	...
	class UI_ButtonABlue extends fgui.GButton {
	    static createInstance() {
	        return (fgui.UIPackage.createObject("Test", "ButtonABlue"));
	    }
	    onConstruct() {
	        this.m_ctrlGrayed = this.getControllerAt(1);
	        this.m__iconBg = (this.getChildAt(0));
	    }
	}
	UI_ButtonABlue.URL = "ui://jchavkemf7t81";

	class UI_ButtonAYellow extends fgui.GButton {
	    static createInstance() {
	        return (fgui.UIPackage.createObject("Test", "ButtonAYellow"));
	    }
	    onConstruct() {
	        this.m_ctrlGrayed = this.getControllerAt(1);
	        this.m__iconBg = (this.getChildAt(0));
	...
	UI_ButtonAYellow.URL = "ui://jchavkemf7t82";

	class UI_ButtonBack extends fgui.GButton {
	    static createInstance() {
	        return (fgui.UIPackage.createObject("Test", "ButtonBack"));
	    }
	    onConstruct() {
	        this.m__iconBack = (this.getChildAt(0));
	    }
	}
	UI_ButtonBack.URL = "ui://jchavkemf7t83";

	class UI_TestPanel extends fgui.GComponent {
	    static createInstance() {
	        return (fgui.UIPackage.createObject("Test", "TestPanel"));
	    }
	    onConstruct() {
	        this.m_bg = (this.getChildAt(0));
	        this.m_btnBlue = (this.getChildAt(1));
	        this.m_btnYellow = (this.getChildAt(2));
	        this.m_btnBack = (this.getChildAt(3));
	    }
	}
	UI_TestPanel.URL = "ui://jchavkemu9i50";
	...
	class UI_Test5Panel extends fgui.GComponent {
	    static createInstance() {
	        return (fgui.UIPackage.createObject("Test5", "Test5Panel"));
	    }
	    onConstruct() {
	...
	UI_Test5Panel.URL = "ui://jor1ejw3f7t81";
